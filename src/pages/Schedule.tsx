        ...
        <section className="pt-16 md:pt-24 mb-16">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-8xl font-extrabold tracking-tighter mb-8 leading-[1] text-white">
              Sledge <span className="text-green-500 text-grad">Schedule</span>
            </h1>
            <p className="text-white/50 text-lg md:text-xl font-light leading-relaxed mb-6">
              View the full week-by-week schedule for the Sledge Mentorship program. Master the core competencies required for high-impact growth.
            </p>
          </div>
        </section>
          ...
          {loading ? (
            ...
            <div className="relative overflow-hidden rounded-[3rem] border border-white/10 bg-white/[0.02] p-12 md:p-20 text-center backdrop-blur-xl">
              ...
              <div className="relative z-10 max-w-lg mx-auto">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 italic">Schedule Coming Soon</h3>
                <p className="text-white/40 text-base md:text-lg mb-10 font-light leading-relaxed">
                  We're currently finalizing the training modules for the upcoming cohort. The full path to success will be revealed shortly.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  >
                    Return to Mentorship <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </div>
              </div>
            </div>
